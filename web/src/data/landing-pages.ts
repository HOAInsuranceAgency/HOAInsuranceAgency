...
/** Paid-traffic landing copy. Regional focus does not limit nationwide licensure. */
...
export const landingPages: LandingPageData[] = [
  {
    ...
    trustSignals: [
      ...
      "Built for MA condominium trust structures",
      "Per-unit water deductible specialists",
    ],
    urgencyText: "MA renewal season is approaching — most carriers want 60+ days of lead time",
  ...
  },
  {
    ...
    trustSignals: [
      "Coastal RI condominium exposure is core to what we place",
  ...
  },
  {
    ...
    trustSignals: [
      "Freeze and ice dam exposure drives how we build NH coverage",
  ...
  },
  {
    ...
    trustSignals: [
      "Connecticut CIOA requirements built into every submission",
      "Water damage terms and deductibles get a line-by-line review",
      "Fairfield County high-value property limits",
    ],
    urgencyText: "Water damage terms tighten at renewal across CT — is your coverage keeping up?",
    metaTitle: "Free Connecticut HOA Insurance Assessment — ProtectMyHOA",
    metaDescription: "Free coverage assessment for Connecticut HOA and condominium associations. CIOA requirements, water damage, and aging buildings.",
  },
  {
    slug: "new-york",
    state: "New York",
    ...
    trustSignals: [
      "NYC Local Law 11 (FISP) and its effect on valuation",
      "High-rise and cooperative corporation specialists",
      "New York's demanding insurance requirements shape every submission",
    ],
  ...
  },
  {
    ...
    trustSignals: [
      "Catastrophic weather exposure is the center of every OK placement",
    ...
    metaDescription: "Free coverage assessment for Oklahoma HOA and condominium associations. Hail, wind, tornado, and severe storm coverage.",
  },
  {
    slug: "new-england",
    region: "New England",
    headline: "New England HOA Insurance — Free Coverage Assessment",
    subheadline: "Massachusetts, Rhode Island, New Hampshire, and Connecticut associations share common challenges: freeze damage, aging buildings, strict codes, and rising water claims. Community association coverage is a core focus of our insurance agency.",
    trustSignals: [
      "Based in Marlborough, MA — serving all of New England",
      `Licensed in ${AGENCY.areaServed} — New England is simply the home market`,
      "Freeze, ice dam, and water damage coverage is a core focus",
      "Multi-state carrier relationships across the region",
      "Built for MA trusts, RI coastal, NH mountain, and CT CIOA requirements",
    ],
    ...
    metaDescription: `Free coverage assessment for New England HOA and condominium associations. Serving MA, RI, NH, and CT — licensed in ${AGENCY.areaServed}.`,
  },
];
