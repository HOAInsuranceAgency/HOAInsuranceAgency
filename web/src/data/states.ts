...
function pending(name: string, abbr: string, slug: string): StateData {
  return {
    ...
    description: `HOA master insurance and HO-6 condo unit owner coverage for ${name} community associations. Independent insurance agency with no broker fee.`,
    ...
    regulations: [
      ...
      "Deductible structure, and per-unit water deductibles in particular, can shift exposure onto individual owners",
