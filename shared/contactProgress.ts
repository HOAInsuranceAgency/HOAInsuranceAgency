...
export function contactProgress(c: Communication): "CONTACT" | "ATTEMPT" | undefined {
  ...
  if (c.direction !== "OUTBOUND" || !["EMAIL", "SMS"].includes(c.channel) || !["SENT", "DELIVERED"].includes(c.status)) return;
...
export function sameContact(a: Communication, b: Communication): boolean {
